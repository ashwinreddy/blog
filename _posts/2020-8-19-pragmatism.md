...
Enlightenment thinker Rene Descartes considered mind and body separate entities, an idea that makes sense only if reason is thought to be inherently correct and proper.

Our inherent irrationality raises questions about the Enlightenment's projects. However, it does not demolish its creations entirely. After all, the scientific method mitigates some irrational thinking by requiring empirical evidence, encouraging skepticism, and refusing to discuss questions that are not testable and falsifiable.


# _Malum malum_

In his _Meditations_, Descartes doubts all his beliefs. He asks himself, "how do I know my beliefs are true?" He seeks to discard any beliefs he has reason to doubt. If his ideas are a barrel of apples, then he wants to throw out the rotten doubtful ones. Then, he will be left with only good apples, irrefutable beliefs.

The aim of Descarte's project is noble but fundamentally doomed. He must have thought some beliefs were impervious to doubt. Not the case. Explain a belief, any belief you hold, to a child. No matter what you say, the child can ask why or how you know that is true. After you respond, the child is still justified in asking again. At what point can we stop doubting?

The [Münchhausen trilemma](https://en.wikipedia.org/wiki/M%C3%BCnchhausen_trilemma) asserts that every such conversation bottoms out in a circular argument, an argument which never ends, or an axiom. An axiom is a premise that must be accepted without proof. Unable to salvage the Cartesian project, we make a compromise to disqualify circular and never-ending arguments. 

The case for reason is looking less strong if it requires us to take certain beliefs on faith because we hoped reason would eliminate faith entirely.
...
[^cheeky-comment]: A more apt name would be metamodel, but I couldn't help myself.
...
[^quote]: See [here](https://academic.oup.com/teamat/article-abstract/2/2/55/1634772)
...
My model of truth offers an answer: if the analogy helps the student solve a problem or reason about a circuit, it is true enough. If the analogy muddies their thinking or fails to provide a solution to a problem the student wants to solve, it is a subpar model.

Since we all lack experiences and theoretical models, let's share our work! Models can easily be extended and inspire future work. In fact, this entire post was motivated by the **pragmatic maxim**: 
...
The relevance (or lack thereof) of a university's motto can be questioned, but notice the motifs of truth and light:

|University|Motto|Meaning|
|:----------:|:-----:|:------:|
|Harvard|_Veritas_|Truth|
|Yale|_Lux et veritas_|Light and truth|
|University of California|_Fiat lux_|Let there be light|

I like the metaphor of light. Humans are visual creatures, and our ability to see and navigate depends crucially on ambient sources of light. It seems fitting that interesting ideas are labeled illuminating and intelligent people deemed brilliant. Truth is more difficult to broach -- ideas of what is true and false vary over time and place and between people. I think models are the truth of the 21st century.
